      ...
      <Container>
        <nav className="flex justify-between flex-wrap items-center">
          <div className="flex items-center">
            ...
            <div className="inline-bock px-6 py-2 duration-200 hover:text-white">
              <a
          ...
          {/* 
          <ul
            className={`ml-auto md:w-auto md:items-center md:flex-row flex border-red-600  md:max-h-full  navbar ${
              navOpen ? "open" : "closed"
            }`}
          > */}
          ...
          >
            ...
            {authStatus ? (
              <li onClick={closeNavbar} className="flex gap-3">
              ...
              <li className="my-4 md:my-0">
                ...
                <NavLink
                  onClick={closeNavbar}
                  to={"/signup"}
                  className="md:ml-4 py-2 px-5 text-white button-custom rounded-lg shadow-sm hover:scale-105 duration-200 hover:cursor-pointer bg-customPurple hover:bg-white hover:text-black"
                >
                  {" "}
                  Signup{" "}
                </NavLink>{" "}
